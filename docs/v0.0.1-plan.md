...
- [x] MCP: memory search/get/timeline, task create/update/review, job run/status, context, `POST /mcp/tool` HTTP endpoint — 16 tests in `packages/mcp/src/mcp.test.ts`.
